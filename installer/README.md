...
- `dist/OmniScript-1.0.4-macOS.dmg` (on macOS with hdiutil)
- `dist/OmniScript-1.0.4-macOS.tar.gz` fallback on Linux
...
Output:
- `dist/omniscript_1.0.4_amd64.deb`
- `dist/omniscript-1.0.4-linux-amd64.tar.gz`
...
Output:
- `dist/omniscript-1.0.4-1.x86_64.rpm`
...
# or
sudo apt install ./dist/omniscript_1.0.4_amd64.deb

sudo rpm -i dist/omniscript-1.0.4-1.x86_64.rpm
# or
sudo dnf install ./dist/omniscript-1.0.4-1.x86_64.rpm
```
...
```bash
tar -xzf dist/omniscript-1.0.4-linux-amd64.tar.gz -C /tmp
