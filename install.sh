...
NIGHTLY_RUN="${OMNISCRIPT_NIGHTLY_RUN:-32066743090}"
...
if [ "$RELEASE_AVAILABLE" -eq 1 ]; then
    ...
    case "$ASSET" in
        omni-linux-arm64) EXPECTED=9d3f14befaeefb64af00e888cd7e732c3d334b5f34a996124eb81a0af898cd07 ;;
        omni-linux-x86_64) EXPECTED=b17641f4e5b4ed5bc93e81b1db00eae4abdd120ce140c619ac71c9128c0315aa ;;
        omni-macos-arm64) EXPECTED=ff0ef6d2e2b4c39275deed94ee3a55595543eef2c9620002d8136c3912e90289 ;;
